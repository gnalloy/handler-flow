...
- Import path: `gnalloy.org/handler-flow`
- Repository: `github.com/gnalloy/handler-flow`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/handler-flow@dev`
- License: Apache-2.0
...
This repository owns: Inbound flow-control handlers for Gnalloy pipelines with bounded pending message and byte budgets.
